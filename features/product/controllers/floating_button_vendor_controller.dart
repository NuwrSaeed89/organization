...
class FloatingButtonsVendorController extends GetxController {
...
ProductModel p=ProductModel.empty();
  ...
  final double iconActivationThreshold = 40.0;
bool isLike=false;
  ...
  final List<Map<String, dynamic>> iconsData = [
    ...
    //{"icon":CupertinoIcons.heart_circle_fill, "label": "like"},
                      ...
                      builder: (BuildContext context) {
                        return ConfirmationDialog(
                            ...
                            onYesPressed: () => ProductController.instance
                                .deleteProduct(p, p.vendorId));
                      });
      case 'edit':
         EditProductController.instance.init(p);
                  Navigator.push(
                      Get.context!,
                      MaterialPageRoute(

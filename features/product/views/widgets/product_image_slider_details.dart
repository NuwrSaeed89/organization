          ...
          TRoundedContainer(
            ...
            child: CarouselSlider(
              options: CarouselOptions(
                onPageChanged: (index, _) => controller.selectdindex.value = index,
                  ...
                  child: Center(
                    child: ListView.separated(
                      ...
                      itemBuilder: (_, index) => Obx(
                        () => TRoundedContainer(
                          width: index == controller.selectdindex.value ? 8 : 4,
                         radius: BorderRadius.circular(100),
                         enableShadow: true,
                         showBorder: true,
                          //  height: .5,
                          // margin: const EdgeInsets.only(right: 2, left: 2),
                          backgroundColor: index == controller.selectdindex.value
                              ? TColors.primary
                              : TColors.white,
                        ),
                      ),
